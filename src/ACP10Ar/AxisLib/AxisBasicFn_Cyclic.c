...
// Power - good
	// dumb power - good
	// smart shouldPower - not good, think about it later
// InitModPos - good
	// Factor or Period set in CFG - good
	// Factor or Period set in nc map - good
// Reference - good
// MoveAbsolute - good
// MoveAdditive - good
// MoveVelocity - good
...
// Set Busy - looks close enough
// Set Done - looks close enough
	
// ReadAxisError FUB inputs - good
// Setting ErrorID and ErrorCount - good
	// ReadAxisError Error - not tested. not sure how.
	// Other errors - good
// Setting Error - good
// Setting Warning - not tested. not sure how.
// Setting WarningCount - good
// Setting ErrorString - good

// Reset - good

// Check NWCT - good
	// No spam on loss of network - good
	// No spam on 0 pAxis - good
...
plcbit AxisBasicFn_Cyclic(struct AxisBasic_typ* t)
{
	...
	MC_BR_ReadAxisError(&t->Internal.FUB.ReadAxisError);
	...
	if (t->Internal.FUB.ReadAxisError.AxisWarningCount != 0) {
		t->OUT.Warning = 1;
	} else {
		t->OUT.Warning = 0;
	}
